...
using Tag = LinkManager.DAL.Models.Tag;
...
namespace LinkManager
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //options.UseInMemoryDatabase("LinkManager"));
            ...
            services.AddScoped<IRepository<Link>, BaseRepository<Link>>();
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Link Manager", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Link Manager V1");
            });
